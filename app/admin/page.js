...
export default function AdminPage() {
    ...
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="text-center max-w-md p-8 bg-red-50 rounded-2xl">
          ...
          <button onClick={() => window.location.reload()} className="mt-4 bg-red-600 text-white px-6 py-2 rounded-lg hover:bg-red-700">
            Coba Lagi
          </button>
        </div>
      </div>
    ...
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="text-center">
          ...
          <button onClick={() => router.push('/dashboard')} className="mt-6 bg-blue-600 px-6 py-2 rounded-lg hover:bg-blue-700 transition">
        ...
        return (
          <>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-6">
              <div id="users" className="bg-gray-800 p-4 md:p-6 rounded-2xl">
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      <h1 className="text-3xl font-bold text-yellow-400 mb-6">👑 Dashboard Admin</h1>
